...
def predict_result(image_tensor):
    ...
    class_name = dict()
    class_name["c0"] = "SAFE DRIVING"
    class_name["c1"] = "TEXTING RIGHT"
    class_name["c2"] = "TALKING PHONE RIGHT"
    class_name["c3"] = "TEXTING LEFT"
    class_name["c4"] = "TALKING PHONE LEFT"
    class_name["c5"] = "OPERATING RADIO"
    class_name["c6"] = "DRINKING"
    class_name["c7"] = "REACHING BEHIND"
    class_name["c8"] = "HAIR AND MAKEUP"
    class_name["c9"] = "TALKING TO PASSENGER"
